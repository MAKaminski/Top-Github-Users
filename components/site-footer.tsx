          ...
          */}
          {PRODUCT_HUNT ? (
            ...
            >
              ...
              <img
                src={`https://api.producthunt.com/widgets/embed-image/v1/product_review.svg?product_id=${PRODUCT_HUNT.productId}&theme=${PRODUCT_HUNT.badge.theme}`}
                alt="Commitgraph — the most active developers on GitHub | Product Hunt"
                width={PRODUCT_HUNT.badge.width}
                height={PRODUCT_HUNT.badge.height}
                // Explicit dimensions plus lazy loading: the footer sits below
                // the fold on every route, and the box is reserved either way so
                // a slow badge cannot shift the layout under a reader.
                loading="lazy"
                decoding="async"
              />
            </a>
